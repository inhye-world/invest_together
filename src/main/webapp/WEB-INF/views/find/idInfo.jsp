				...
				<div class="content__body">
					<div class="content__body__page">
						...
						<section class="login">
							<article class="notification">
								...
								<dl class="notification__txt">
									...
									<dt>
										...
										<br>
										<span class="color-blue">총${id}.개</span>
										입니다.
									</dt>
								</dl>	
							</article>
							...
							<c:choose>
								<c:when test="${dto.sns_type eq 'normal'}">${dto.id}</c:when>
							    
							<hr>
								<c:when test="${dto.sns_type eq 'kakao'}"> 네이버 계정</c:when>
							     
							<hr>
								<c:when test="${dto.sns_type eq 'naver'}">카카오 계정</c:when>
