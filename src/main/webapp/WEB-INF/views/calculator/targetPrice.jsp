          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
				...
				<button type="button" class="btn btn-outline btn-primary pull-right" onclick="calculate();">계산</button>   	
              	<button type="button" class="btn btn-outline btn-primary pull-right" onclick="refresh();">초기화</button>              	
              	
              	<span id="myTable"><p></p></span>
		                  ...
		                  '<tbody>'+
		                	...
		                	'</table>'+
		             		...
		             		var frm = 
		                      ...
		                      '<input type="submit" class="btn btn-outline btn-primary pull-right" value="저장" />'+
		                      '</form>';
